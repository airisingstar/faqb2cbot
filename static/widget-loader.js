(() => {
  ...
  leadModal.innerHTML = `
    ...
    ">
      ...
      <label>Name</label>
      <input id="lead-name" style="width:100%;margin:6px 0 12px;padding:8px;border-radius:8px;border:1px solid #ccc"/>
      <label>Email</label>
      <input id="lead-email" style="width:100%;margin:6px 0 12px;padding:8px;border-radius:8px;border:1px solid #ccc"/>
      <label>Phone</label>
      <input id="lead-phone" style="width:100%;margin:6px 0 16px;padding:8px;border-radius:8px;border:1px solid #ccc"/>
      <label>Message</label>
      <textarea id="lead-message" rows="3" style="width:100%;padding:8px;border-radius:8px;border:1px solid #ccc"></textarea>
  ...
  // Listen for messages from iframe (chatbot)
  ...
  window.MyAiToolsetWidget = {
    toggle: toggleChat,
    open: () => { iframe.style.display = "block"; iframe.style.opacity = 1; },
    close: () => { iframe.style.opacity = 0; setTimeout(() => (iframe.style.display = "none"), 200); },
    openLeadForm,
  };

  console.log("✅ MyAiToolset widget loader (Smart Lead Form) active");
})();
